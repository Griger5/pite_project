...
def plot_waveform(
    audio_channel, output_path="../../../audio_output_files/waveform.png"
):
...
def plot_melspectrogram(
    ...
    sample_rate,
    hop_length=512,
    output_path="../../../audio_output_files/spectrogram.png",
):
    plt.figure(figsize=(10, 4))
...
def compute_log_mel_spectrogram(
    audio_data, sample_rate, mel_band_num=128, sample_frame_length=2048, hop_length=512
):
...
def read_sound(file="../../../audio_samples/sample-3s.wav"):
